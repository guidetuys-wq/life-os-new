...
export default function Dashboard() {
    ...
    // 1. Ambil semua data & logic dari Custom Hook
    // Hook ini menghandle subscription ke Profile, Finance, Identity, Tasks, dan Project Candidates
    const { 
        isLoading, stats, finance, activeTasks, 
        projectCandidates, // List semua project aktif untuk dropdown pilihan
        identityData, setIdentityData 
    } = useDashboardData(user);

    // 2. Kalkulasi Visual XP Bar
            ...
            <div className="p-8 max-w-7xl mx-auto flex flex-col gap-8 animate-pulse">
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
                    ...
                    <div className="md:col-span-8 flex flex-col gap-6">
                        <div className="h-20 bg-slate-900/50 rounded-2xl w-full"></div>
                        <div className="h-64 bg-slate-900/50 rounded-2xl w-full"></div>
                    </div>
                    {/* Right Column Skeleton */}
                    <div className="md:col-span-4 flex flex-col gap-6">
                        <div className="h-40 bg-slate-900/50 rounded-2xl w-full"></div>
                        <div className="h-40 bg-slate-900/50 rounded-2xl w-full"></div>
                    </div>
                </div>
            </div>
    ...
    return (
        <div className="p-4 md:p-8 max-w-7xl mx-auto pb-32 animate-enter font-sans">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 md:gap-8">
                ...
                <div className="lg:col-span-8 flex flex-col gap-8">
                    ...
                    {/* A. Identity & Manual Focus Card */}
                    {/* User bisa edit identitas dan memilih project fokus sendiri */}
                    <IdentityCard 
                        user={user}
                    ...
                    {/* B. XP Bar & Level (Versi Compact) */}
                    <div className="bg-slate-900/30 border border-white/5 rounded-2xl p-4 flex items-center justify-between gap-4 backdrop-blur-sm">
                    ...
                    {/* C. Inbox Widget */}
                    {/* Tasks dilempar sebagai props agar tidak fetch ulang */}
                ...
                <div className="lg:col-span-4 flex flex-col gap-6">
                    ...
                    {/* E. Total Balance Display */}
                    <Link href="/finance" className="glass-card p-5 relative overflow-hidden group cursor-pointer hover:border-emerald-500/30 transition-all">
